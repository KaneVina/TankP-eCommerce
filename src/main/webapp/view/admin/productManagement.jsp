                            ...
                            <div class="account-content-main">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h3 class="account-sub-title d-none d-md-block mb-0">
                                        <i class="fas fa-list align-middle mr-3"></i
                                        >Product Management
                                    </h3>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex mr-2 product-search-bar">
                                            <input
                                                ...
                                                />
                                            <button
                                                class="btn btn-sm btn-search-custom"
                                                type="button"
                                                title="Search"
                                                >
                                        ...
                                        <button
                                            class="action-btn btn-filter shadow-sm mr-2"
                                            title="Filter"
                                            >
                                        ...
                                        <button
                                            type="button"
                                            class="action-btn btn-create shadow-sm"
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="data-table-td-style">3</span></td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <button
                                                        class="action-btn btn-delete mx-1"
                                                        title="Delete"
                                                        >
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="data-table-td-style">45</span></td>
