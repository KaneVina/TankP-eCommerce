                        ...
                        <div class="tab-pane fade show active">
                            <div class="account-content-main">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h3 class="account-sub-title d-none d-md-block mb-0"> <i class="fas fa-boxes align-middle mr-3"></i>My Order History</h3>
                            ...
                            <div class="data-table-style text-center">
                                <table class="table table-hover table-striped">
                                    <thead> <tr> <th>ID</th>  <th>DATE</th> <th>TOTAL AMOUNT</th> <th>STATUS</th> <th>ACTIONS</th> </tr> </thead>
                                    <tbody>
                                        <%-- Sample Order 1 --%>
                                        <tr>
