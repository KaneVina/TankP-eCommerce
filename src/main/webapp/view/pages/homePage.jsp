...
<html lang="en">
        ...
        <jsp:include page="../common/header.jsp"></jsp:include>
            <main class="main">
                ...
                <div class="home-slide home-slide2 banner banner-md-vw">
                    <img class="slide-bg" style="background-color: #ccc;" width="1903" height="499" src="${pageContext.request.contextPath}/assets/images/demoes/slider/slide-2.jpg" alt="slider image">
                    <div class="container d-flex align-items-center">
    ...
    <!-- Footer Start -->
    <jsp:include page="../common/footer.jsp"></jsp:include>a
