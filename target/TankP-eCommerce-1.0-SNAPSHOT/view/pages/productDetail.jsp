                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6 product-single-details">
                                        ...
                                        <ul class="single-info-list">
                                            <li>QUANTITY: <strong>02</strong></li>
                                                ...
                                                <ul class="config-size-list config-color-list config-filter-list">
                                                    ...
                                                    <li class="">
                                                        <a
                                                            href="javascript:;"
                                                            class="filter-color border-0"
                                                            style="background-color: rgb(96, 133, 165)"
                                                            ></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a href="cart.html" class="btn btn-gray view-cart d-none"
                                               >View cart</a>
                                        </div>
                                ...
                                <div class="tab-content">
                                    <div
                                        ...
                                        <div class="product-desc-content">
                                            ...
                                            <ul>
                                                <li>
                                                    <b>Authenticity & Quality: </b>Every product is 100% brand
                                                    new, authentic, and comes with original tags and
                                                    packaging.
                                                </li>
                                                <li>
                                                    <b>Careful Inspection</b>Each item is thoroughly checked
                                                    and handled with care before delivery to ensure it reaches
                                                    you in perfect condition.
                                                </li>
                                                <li>
                                                    <b>Transparent Information</b>All product images and
                                                    descriptions provided by TankP are genuine and accurately
                                                    represent the actual items.
                                                </li>
                                            </ul>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td width="50%">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                Requests made within <b>07 days</b> from the date of
                                                                receipt.
                                                            </li>
                                                            <li>
                                                                Products must remain
                                                                <b>unused, in original condition</b>, with intact
                                                                tags and packaging.
                                                            </li>
                                                            <li>
                                                                Items <b>damaged</b> due to shipping or manufacturer
                                                                defects.
                                                            </li>
                                                            <li>
                                                                Products not matching the
                                                                <b>ordered style or specifications</b>.
                                                            </li>
                                                            <li>
                                                                Orders with <b>missing items</b>, incorrect
                                                                quantities, or incomplete sets.
                                                            </li>
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td width="50%">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                Requests made <b>after 07 days</b> from the date of
                                                                receipt.
                                                            </li>
                                                            <li>
                                                                Returned items not matching the original product or
                                                                <b>not purchased from TankP</b>.
                                                            </li>
                                                            <li>
                                                                Customer errors such as
                                                                <b>ordering the wrong product, type</b>, or personal
                                                                preference (e.g., no longer wanted, doesn’t fit,
                                                                doesn’t suit).
                                                            </li>
                                                        </ul>
                                                    </td>
