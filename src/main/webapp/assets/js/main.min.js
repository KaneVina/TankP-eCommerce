        ...
        initPurchasedMinipopup: function () {
          (t(".product-single").length || t(".main-content").length) &&
            setInterval(function () {
              c.miniPopup.open({
                name: "More promotions with TankP",
                imageSrc: "assets/images/logo/logoDBN.png",
                content: " For any inquiries, please contact +849 324 423",
                action:
                  '<span class="text-primary" style="font-size: 11px;">TankP eCommerce</span>',
              });
            }, 6e4);
        },
